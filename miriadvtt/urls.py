...
from liktertest import views as liktertestviews
...
urlpatterns = [
    ...
    path('WP1_likter/', homeviews.WP1_likter, name='WP1_likter'),
    path('WP3/', homeviews.WP3, name='WP3'),
    path('CT_likter', liktertestviews.CT_Likter_func, name='CT_likter'),
